...
// }
  ...
  return (
    ...
    <div  className='absolute top-3 left-3 ' > <Link to="/users/:userid"> <Avatar className=' ring-4 ring-pink-600 ' src= {props.src} />  </Link> </div>  <Link to="/users/:userid">  <p className=' absolute bottom-2.5 left-2 text-white font-bold '> {props.name}  </p> </Link>
